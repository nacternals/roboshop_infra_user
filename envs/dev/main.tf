...
# ----------------------------
module "network" {
  source = "git::ssh://git@github.com/nacternals/roboshop_terraform_modules.git//01_network?ref=v1.34.5"
...
# ----------------------------
module "security" {
  source = "git::ssh://git@github.com/nacternals/roboshop_terraform_modules.git//02_security?ref=v1.34.5"
...
# ----------------------------
module "iam" {
  source = "git::ssh://git@github.com/nacternals/roboshop_terraform_modules.git//03_iam?ref=v1.34.5"
...
# ----------------------------
module "bastion" {
  source = "git::ssh://git@github.com/nacternals/roboshop_terraform_modules.git//04_bastion?ref=v1.34.5"
...
# ----------------------------
module "mongodb" {
  source = "git::ssh://git@github.com/nacternals/roboshop_terraform_modules.git//05_mongodb?ref=v1.34.5"
...
module "mysql" {
  source = "git::ssh://git@github.com/nacternals/roboshop_terraform_modules.git//06_mysql?ref=v1.34.5"
...
module "redis" {
  source = "git::ssh://git@github.com/nacternals/roboshop_terraform_modules.git//07_redis?ref=v1.34.5"
...
module "rabbitmq" {
  source = "git::ssh://git@github.com/nacternals/roboshop_terraform_modules.git//08_rabbitmq?ref=v1.34.5"
...
# ----------------------------
module "internal_alb" {
  source = "git::ssh://git@github.com/nacternals/roboshop_terraform_modules.git//09_internal-alb?ref=v1.34.5"
...
module "route53_private" {
  source = "git::ssh://git@github.com/nacternals/roboshop_terraform_modules.git//10_route53-private?ref=v1.34.5"
...
module "service_catalogue" {
  source = "git::ssh://git@github.com/nacternals/roboshop_terraform_modules.git//11_service-catalogue?ref=v1.34.5"
...
module "service_cart" {
  source = "git::ssh://git@github.com/nacternals/roboshop_terraform_modules.git//12_service-cart?ref=v1.34.5"
...
module "service_user" {
  source = "git::ssh://git@github.com/nacternals/roboshop_terraform_modules.git//13_service-user?ref=v1.34.5"
...
module "service_shipping" {
  source = "git::ssh://git@github.com/nacternals/roboshop_terraform_modules.git//14_service-shipping?ref=v1.34.5"
...
module "service_payment" {
  source = "git::ssh://git@github.com/nacternals/roboshop_terraform_modules.git//15_service-payment?ref=v1.34.5"
...
module "service_dispatch" {
  source = "git::ssh://git@github.com/nacternals/roboshop_terraform_modules.git//16_service-dispatch?ref=v1.34.5"
...
# ----------------------------
module "acm_public" {
  source = "git::ssh://git@github.com/nacternals/roboshop_terraform_modules.git//20_acm-public?ref=v1.34.5"
...
# ----------------------------
module "public_alb" {
  source = "git::ssh://git@github.com/nacternals/roboshop_terraform_modules.git//18_public-alb?ref=v1.34.5"
...
module "route53_public" {
  source = "git::ssh://git@github.com/nacternals/roboshop_terraform_modules.git//19_route53-public?ref=v1.34.5"
...
# ----------------------------
module "web_nginx" {
  source = "git::ssh://git@github.com/nacternals/roboshop_terraform_modules.git//17_web?ref=v1.34.5"
